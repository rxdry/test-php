...
<form action="step4edenor.php" method="POST">
<div class="container-fluid">
	<div class="row d-flex justify-content-center">
		<div class="col-md-6 col-10 contenedor_recarga">
			<h1>Rellena con el Nº de DNI o de cuenta</h1>
			<h2>Edenor será recargado automaticamente.</h2>
			<div class="row d-flex justify-content-center align-items-center flex-column">
				<div class="col-md-6 col-12">
				   
				   	<label for="numerorecarga">Número de DNI o cuenta</label>
				</div>
				<div class="col-md-6 col-12">
